...
| Role escalation | Central explicit permissions; MEMBER cannot edit/archive; manager/admin allowed; direct API tests independent of UI visibility | Phase 6 role changes are reviewed separately; future permissions still need deny-by-default tests |
